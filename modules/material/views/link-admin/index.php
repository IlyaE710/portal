...
$this->params['sidebar'] = SidebarWidget::widget([
    'items' => [
        [
            ...
            'url' =>  Url::to(['material-admin/update', 'id' => $id ?? $model->materialId]),
        ...
        [
            'label' => 'Ссылки',
            'url' =>  Url::to(['link-admin/index', 'id' => $id ?? $model->materialId]),
            'options' => ['class' => 'nav-link px-0 align-middle text-center'],
        ...
        [
            'label' => 'Файлы',
            'url' =>  Url::to(['file-admin/index', 'id' => $id ?? $model->materialId]),
            'options' => ['class' => 'nav-link px-0 align-middle text-center'],
        ...
        [
            'label' => 'Тексты',
            'url' =>  Url::to(['text-admin/index', 'id' => $id ?? $model->materialId]),
